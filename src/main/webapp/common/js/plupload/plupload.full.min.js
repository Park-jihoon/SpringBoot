(function () {
    ...
    var d = {
        ...
        getSize: function (k) {
            return {w: k.clientWidth || k.offsetWidth, h: k.clientHeight || k.offsetHeight}
        },
    ...
    d.Uploader = function (n) {
        ...
        n = d.extend({chunk_size: 0, multipart: true, multi_selection: true, file_data_name: "file", filters: []}, n);
        function o() {
            var s;
            ...
            init: function () {
                ...
                x.bind("FilesAdded", function (z, C) {
                    ...
                    for (B = 0; B < C.length; B++) {
                        ...
                        if (A.size !== b && A.size > n.max_file_size) {
                            z.trigger("Error", {code: d.FILE_SIZE_ERROR, message: "File size error.", file: A});
                            continue
                        }
                        p.push(A);
                        E++
                ...
                function s() {
                    ...
                    if (C) {
                        ...
                        x.trigger("Error", {code: d.INIT_ERROR, message: "Init error."})
                    }
                }
...
(function (b) {
    ...
    function a(i, e, k, j, d) {
        ...
        g.resize(e, k);
        return g.encode(d, {quality: j / 100})
    }

    b.runtimes.Gears = b.addRuntime("gears", {
        getFeatures: function () {
            return {dragdrop: true, jpgresize: true, pngresize: true, chunks: true, progress: true, multipart: true}
        }, init: function (g, i) {
            var h;
            ...
            g.bind("PostInit", function () {
                var j = g.settings, e = document.getElementById(j.drop_element);
                if (e) {
                ...
                b.addEvent(document.getElementById(j.browse_button), "click", function (o) {
                    ...
                    h.openFiles(d, {singleFile: !j.multi_selection, filter: n})
                })
            });
            g.bind("UploadFile", function (o, l) {
                ...
                function j() {
                    var u, w, s = o.settings.multipart, r = 0, v = {name: l.target_name || l.name};

                    function t(y) {
                        var x, C = "----pluploadboundary" + b.guid(), A = "--", B = "\r\n", z;
                        if (s) {
                    ...
                    u.onreadystatechange = function () {
                        ...
                        if (u.readyState == 4) {
                            if (u.status == 200) {
                                x = {chunk: q, chunks: p, response: u.responseText, status: u.status};
                                ...
                                if (++q >= p) {
                                    l.status = b.DONE;
                                    o.trigger("FileUploaded", l, {response: u.responseText, status: u.status})
                                } else {
                                    j()
                                }
                            } else {
...
(function (c) {
    ...
    c.runtimes.Silverlight = c.addRuntime("silverlight", {
        getFeatures: function () {
            return {jpgresize: true, pngresize: true, chunks: true, progress: true, multipart: true}
        }, init: function (l, m) {
            ...
            l.bind("Silverlight:Init", function () {
                ...
                l.bind("Silverlight:UploadChunkError", function (o, r, p, s, q) {
                    l.trigger("Error", {code: c.IO_ERROR, message: "IO Error.", details: q, file: o.getFile(n[r])})
                });
                ...
                l.bind("Silverlight:UploadChunkSuccessful", function (o, r, p, u, t) {
                    ...
                    if (p == u - 1) {
                        q.status = c.DONE;
                        o.trigger("FileUploaded", q, {response: t})
                    }
                });
                l.bind("Silverlight:UploadSuccessful", function (o, r, p) {
                    var q = o.getFile(n[r]);
                    q.status = c.DONE;
                    o.trigger("FileUploaded", q, {response: p})
                });
                ...
                l.bind("UploadFile", function (o, q) {
                    ...
                    e().UploadFile(n[q.id], c.buildUrl(o.settings.url, {name: q.target_name || q.name}), b({
        ...
        getFeatures: function () {
            ...
            g.bind("Flash:Init", function () {
                ...
                g.bind("UploadFile", function (q, r) {
                    var s = q.settings;
                    j().uploadFile(p[r.id], c.buildUrl(s.url, {name: r.target_name || r.name}), {
                ...
                g.bind("Flash:UploadChunkComplete", function (q, s) {
                    ...
                    t = {chunk: s.chunk, chunks: s.chunks, response: s.text};
                    ...
                    if (s.chunk == s.chunks - 1) {
                        r.status = c.DONE;
                        q.trigger("FileUploaded", r, {response: s.text})
                    }
                });
...
(function (a) {
    a.runtimes.BrowserPlus = a.addRuntime("browserplus", {
        getFeatures: function () {
            ...
            function b() {
                ...
                g.bind("UploadFile", function (n, k) {
                        ...
                        e.Uploader.upload({
                            ...
                            if (w.success) {
                                ...
                                if (p.length > 0) {
                                    ...
                                    k.status = a.DONE;
                                    n.trigger("FileUploaded", k, {response: w.value.body, status: v});
                                    if (v >= 400) {
                                        n.trigger("Error", {
                                            code: a.HTTP_ERROR,
                                            message: "HTTP Error.",
                    ...
                    function q(s) {
                        k.size = s.size;
                        if (l) {
                            e.FileAccess.chunk({file: s, chunkSize: l}, function (v) {
                                if (v.success) {
            ...
            if (e) {
                e.init(function (k) {
                    var j = [{service: "Uploader", version: "3"}, {
                        service: "DragAndDrop",
                        version: "1"
    ...
    b.runtimes.Html5 = b.addRuntime("html5", {
        getFeatures: function () {
            ...
            f.bind("Init", function (m) {
                var q, o = [], l, p, j = m.settings.filters, k, n, h = document.body;
            ...
            f.bind("UploadFile", function (h, j) {
                var k = h.settings, m, i;

                function l(n) {
                    var q = 0, p = 0;

                    function o() {
                        var u = n, C, D, y, z, A = 0, r = "----pluploadboundary" + b.guid(), t, w, s = "--", B = "\r\n", x = "";
                        if (j.status == b.DONE || j.status == b.FAILED || h.state == b.STOPPED) {
                            return
                        }
                        z = {name: j.target_name || j.name};
                        ...
                        C.onreadystatechange = function () {
                            ...
                            if (C.readyState == 4) {
                                ...
                                if (E >= 400) {
                                    h.trigger("Error", {code: b.HTTP_ERROR, message: "HTTP Error.", file: j, status: E})
                                } else {
                                    if (y) {
                                        G = {chunk: q, chunks: y, response: C.responseText, status: E};
                                    ...
                                    if (!y || ++q >= y) {
                                        j.status = b.DONE;
                                        h.trigger("FileUploaded", j, {response: C.responseText, status: E})
                                    } else {
                                        o()
                                    }
                                }
    ...
    a.runtimes.Html4 = a.addRuntime("html4", {
        getFeatures: function () {
            ...
            f.bind("Init", function (p) {
                var h, x, v, t = [], o, u, m = p.settings.filters, l, s, r = /MSIE/.test(navigator.userAgent), k = "javascript", w, j = document.body, n;
                if (f.settings.container) {
                ...
                a.each(p.settings.multipart_params, function (z, y) {
                    ...
                    a.extend(i, {type: "hidden", name: y, value: z});
                    c.appendChild(i)
                });
                ...
                a.addEvent(b, "load", function (B) {
                    ...
                    try {
                        ...
                        p.trigger("Error", {code: a.SECURITY_ERROR, message: "Security error.", file: z});
                        return
                    }
                    ...
                    if (i != "") {
                        ...
                        p.trigger("FileUploaded", z, {response: i});
                        if (c.tmpAction) {
                ...
                if (w) {
                    a.extend(x.style, {background: w, opacity: 1})
                }
                ...
                function q() {
                    ...
                    a.extend(v.style, {width: "100%", height: "100%", opacity: 0});
                    if (r) {
                        a.extend(v.style, {filter: "alpha(opacity=0)"})
                    }
            ...
            f.bind("UploadFile", function (h, i) {
                ...
                c.setAttribute("action", a.buildUrl(h.settings.url, {name: i.target_name || i.name}));
